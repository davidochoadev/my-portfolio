  ...
  return (
    <section className="relative h-screen flex justify-center">
      ...
      <div className="mx-4 bg-white w-full h-full rounded-3xl self-center flex justify-center flex-col relative">
        ...
        <iframe className="hidden md:inline-block" width="100%" height="100%" src="https://ionicabizau.github.io/github-profile-languages/api.html?davideochoaa" frameBorder="0" title="my programming languages stats"></iframe>
      </div>
    </section>
  );
}