  ...
  return (
    ...
    transition={{ duration: 1 }} className="relative h-screen flex snap-start ">
      ...
      <div className="mx-4 justify-center md:mx-auto w-full h-full max-h-min flex flex-col items-center md:flex-row md:justify-center">
        ...
        className="w-full lg:w-1/3 md:pt-0 md:flex md:items-center md:flex-col md:my-auto md:px-4 pb-4"
        >
        ...
        <div className="md:h-full w-full md:flex md:items-center md:px-4 lg:w-1/2 lg:max-w-md group transition duration-300 ease-in">
          <a href="#about" className="relative cursor-pointer flex flex-col justify-center shadow-md bg-[#33DDB3] rounded-3xl w-full h-min md:h-auto p-2 max-h-min mx-auto container lg:w-5/6 md:flex md:items-center group-hover:rounded-full group-hover:scale-[0.8] transition duration-300 ease-in">
